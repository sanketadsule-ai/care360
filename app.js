...
(function () {
  ...
  let state = {
    ...
    cases: JSON.parse(localStorage.getItem('inbox_cases') || '[]'),
  ...
  const DEFAULT_CASES = [
    {
      ...
      text: 'On their way home from a wedding, my parents met with a devastating #accident. I lost my father, and my mother is in critical condition. Please help us raise funds for her treatment.',
    ...
    },
    {
      ...
      text: 'Amen',
      createdTime: new Date(Date.now() - 40 * 60 * 60 * 1000).toISOString(),
      type: 'Comment',
      status: 'Open',
      priority: 'Low',
      assignedTo: 'Unassigned',
    ...
    },
    {
      id: 'case-4',
      source: 'Impact Guru',
      author: 'Namita Naskar',
      channel: 'facebook',
      avatarGradient: 'linear-gradient(135deg, #ec4899, #f43f5e)',
      text: 'god bless you',
      createdTime: new Date(Date.now() - 44 * 60 * 60 * 1000).toISOString(),
      type: 'Comment',
      status: 'Open',
      priority: 'Low',
      assignedTo: 'Unassigned',
  ...
  const GMAIL_MOCK_CASES = [
    {
      ...
      author: 'roshansalunke91@gmail.com',
      channel: 'gmail',
      avatarGradient: 'linear-gradient(135deg, #EA4335, #E53E3E)',
      text: 'Support Ticket #94821: Urgent inquiry regarding donation campaign verification process.',
      createdTime: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
      type: 'Email',
      status: 'Open',
      priority: 'High',
      assignedTo: 'SC',
      emailSubject: 'Support Ticket #94821: Urgent inquiry regarding donation campaign verification process',
      emailAttachments: [
        { name: 'campaign_doc.pdf', size: '1.2 MB' },
        { name: 'tax_certificate.png', size: '840 KB' }
      ],
      messages: [
        {
          id: 'msg-g1-1',
          sender: 'roshansalunke91@gmail.com',
          text: `Dear Support Team,

I recently set up a fundraiser page under the name "Impact Guru Parents Accident Appeal". However, the page shows a warning "Verification Pending". 

I have attached our registration documents and tax exemption certificate for verification. Could you please review these files as soon as possible? My mother is in the ICU and we need to start receiving donations urgently.
...
Roshan Salunke`,
    ...
    },
    {
      ...
      text: 'Invoice Care360-2026-06: Verification of monthly corporate billing cycle.',
      createdTime: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
      type: 'Email',
      status: 'Open',
      priority: 'Medium',
      assignedTo: 'Unassigned',
      emailSubject: 'Invoice Care360-2026-06: Verification of monthly corporate billing cycle',
      emailAttachments: [
        { name: 'invoice_2026_06.pdf', size: '240 KB' }
      ],
      messages: [
        {
          id: 'msg-g2-1',
...
This is an automated notification that invoice Care360-2026-06 has been generated for your corporate account. The total amount of $299.00 will be auto-debited from your linked Visa card ending in 4321 on June 25, 2026.

If you have any billing discrepancies or want to update your billing details, please reply directly to this email.
